...
class PropertyChatDialog extends StatelessWidget implements ApiStatusLogin {
  var documentId;



  PropertyChatDialog({ required this.documentId});
              ...
              child: Container(
                child: Container(
                  ...
                  child: FutureBuilder<DocumentSnapshot>(
                    future: value.getPropertyAdsDetails(
                        documentId),
